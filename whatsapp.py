...
def whatsappp():
    async def physreg():
        try:
            ...
            async with aiohttp.ClientSession() as sess:
                async with sess.post('https://api.penpencil.co/v1/users/register/5eb393ee95fab7468a79d189',
    ...
    async def potfull():
        try:
            ...
            async with aiohttp.ClientSession() as sess:
                async with sess.post('https://api.restro.app/authentication/customerSignup', params=params,
    ...
    async def foxi():
        try:
            ...
            async with aiohttp.ClientSession() as sess:
                async with sess.post('https://www.foxy.in/api/v2/users/send_otp', headers=headers,
                                     json=json_data) as response:
                    return "ok"
        except Exception as e:
            return "failed"
    ...
    async def wakefit():
        try:
            ...
            async with aiohttp.ClientSession() as sess:
                async with sess.post('https://api.wakefit.co/api/consumer-sms-otp/', headers=headers,
                                     json=json_data) as response:
                    return "ok"
        except Exception as e:
            return "failed"
